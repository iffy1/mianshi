...
public class XiangXueFlowLayout extends ViewGroup {
    ...
    public XiangXueFlowLayout(Context context) {
        super(context);
//        initMeasureParams();
    }

    public XiangXueFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
//        initMeasureParams();
    }

    public XiangXueFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
